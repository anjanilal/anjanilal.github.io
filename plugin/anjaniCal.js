...
$(document).ready(function() {
    style = '<style>#gcal-table{margin:0px;} .gcal-tzone{color:rgb(202,211,236);font-size:12px;} .gcal-datetime {font-weight:bold;font-size: 20px;}.event-desc {word-wrap: break-word;font-size:11px;text-decoration:none;}#wapper #bottomwapper #gcalender #gcal {font-size: 25px;text-align:left;display:block;position:absolute;overflow:hidden;width: auto;height: auto;border: none; position:relative}a:link,a:visited,a:hover,a:active {text-decoration:none;}.gcal-rpointer {position: absolute;right: -15px;top: 90px;font-size: 30px;font-weight: bold;color: rgb(213,63,53);width: 35px;height: 35px;padding-bottom: 7px;padding-left: 5px;cursor:pointer;cursor:mouse;border-radius: 35px;}.gcal-lpointer {position: absolute;left: -15px;top: 90px;font-size: 30px;font-weight: bold;color: rgb(213,63,53);width: 35px;height: 35px;padding-bottom: 7px;padding-left: 5px;cursor:pointer;cursor:mouse;border-radius: 35px;}</style>';
    $('html > head').append(style);
    var moreStyle = '<style>.event-header {text-align: center;width: 300px;height: 96px;background-color: rgb(46,46,46);color: white;padding: -0px;padding-bottom: 0px;border: none;position: absolute;}.event-header-holder {position: relative;width: 100%;top: 20px;}.event-day {font-size: 24px;padding-bottom: 0px;display: inline-block;}.event-date {font-size: 30px;font-family: Georgia;}.event-year {font-size: 24px;padding-top: 10px;display: inline-block;}.event-body {cursor:pointer;cursor:mouse;width: 500px;height: 90px;border: none;padding: 3px;background-color: rgb(46,46,46);color: white;overflow: hidden;text-decoration: none;position: static;display:inline-block;margin-left:301px;}.event-title {color: rgb(255,216,177);font-weight: bold;}.event-location {color:rgb(255,0,128);font-size: 13px;}#load-more {background-color: rgb(46,46,46);visibility:none;border: none;display: block;padding: 3px;text-align: center;color: white;font: 13px arial,sans-serif;font-weight: bold;float: left;width: 800px;height: 90px;margin-left: -3px 2%;cursor: pointer;cursor: mouse;line-height: 100px;}.load-more:hover{background-color:red;}.gcal-datetime-extended {font-weight: bold;font-size: 13px;color: rgb(181,230,29);}.event-img {cursor:pointer;cursor:mouse;width: 110px;height: 110px;border: none;padding: 3px;color: black;overflow: hidden;background-repeat: no-repeat;background-size: cover;}</style>';
...
function showEvents(data) {
    ...
    for (var i = 0; i < eventArray.length; i++) {
        ...
        if (null != event_location && event_location != "undefined" && event_location != "") {
            eventHTML += "<br/>@ <span class='event-location'>" + event_location + "</span>  &nbsp;&nbsp;"
        }
