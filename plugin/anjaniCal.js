...
$(document).ready(function() {
    style = '<style>#gcal-table{margin:0px;}.gcal-tzone{color:rgb(202,211,236);font-size:12px;}.gcal-datetime {font-weight:bold;font-size: 20px;}.event-desc {word-wrap: break-word;font-size:11px;text-decoration:none;}#gcal {font-family: Calibri;font-size: 25px;	  text-align:left;display:block;position:absolute;overflow:auto;width:' + eventWidgetWidth + 'px;height: 723px;border: none;}a:link,a:visited,a:hover,a:active {text-decoration:none;}.gcal-rpointer {position: absolute;right: -15px;top: 90px;font-size: 30px;font-weight: bold;color: rgb(213,63,53);width: 35px;height: 35px;padding-bottom: 7px;padding-left: 5px;cursor:pointer;cursor:mouse;border-radius: 35px;}.gcal-lpointer {position: absolute;left: -15px;top: 90px;font-size: 30px;font-weight: bold;color: rgb(213,63,53);width: 35px;height: 35px;padding-bottom: 7px;padding-left: 5px;cursor:pointer;cursor:mouse;border-radius: 35px;}</style>';
